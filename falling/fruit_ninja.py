...
WIDTH = 800
HEIGHT = 500
FPS = 8                                            #controls how often the gameDisplay should refresh. In our case, it will refresh every 1/5th second
pygame.init()
pygame.display.set_caption('falling-Ninja Game in Python -- GetProjects.org')
...
def generate_random_fruits(fruit):
    ...
    data[fruit] = {
        ...
        'speed_y': random.randint(60, 80),    #control the speed of fruits in y-directionn ( UP )
        ...
        if value['throw']:
            ...
            if not value['hit'] and current_position[0] > value['x'] and current_position[0] < value['x']+60 \
                ...
                if key == 'bomb':
                    ...
                    half_fruit_path = "falling/images/explosion.png"
                else:
                    half_fruit_path = "falling/images/" + "half_" + key + ".png"
